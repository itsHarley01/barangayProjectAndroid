...
class IndigencyForm : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_indigency_form, container, false)
        ...
        backbtn.setOnClickListener(){
            findNavController().navigate(R.id.action_indigencyForm_to_home2, bundle)
        }
        ...
        submitButton.setOnClickListener {
            if (!firstNameEditText.text.toString().isEmpty()
                ...
                builder.setPositiveButton("Submit") { _, _ ->
                    uploadBarangayIndigencyData(firstName, middleName, lastName, sex, maritalStatus, contact, address, email, reason)
    ...
    private fun uploadBarangayIndigencyData(
        firstName: String,
        middleName: String,
        lastName: String,
        sex: String,
        ...
        val submissionsRef = database.getReference("submissions/forms/barangay-indigency/pending")
    ...
    companion object {
        private const val TAG = "BarangayIndigencyForm"
    }
}
